from .._base_.datasets.BranchDataset import *
import os
import time

"""Settings for network"""
C.backbone = "DFormerv2_L"
C.pretrained_model = "checkpoints/pretrained/DFormerv2/pretrained/DFormerv2_Large_pretrained.pth"
C.decoder = "ham"
...
C.num_workers = 8
C.train_scale_array = [0.5, 0.75, 1, 1.25, 1.5]
C.warm_up_epoch = 5
C.fix_bias = True
C.bn_eps = 1e-3
C.bn_momentum = 0.1
